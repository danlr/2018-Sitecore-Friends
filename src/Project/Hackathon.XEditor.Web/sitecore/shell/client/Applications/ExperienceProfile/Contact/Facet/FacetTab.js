            ...
            if (jsonData.data.dataSet != null && jsonData.data.dataSet.facet.length > 0) {
			  $.each(jsonData.data.dataSet.facet, function(){
				  ...
				  : dataSet.DepthLevel=="1" 
						? "padding-left: 100px;"
						: "padding-left: 200px;";
				  var $html = $("<div class='control-form-user-editor' style='margin-top: 1em; "+cssClass+"' data-facet-name="+dataSet.FacetName +" />");
				  ...
				  if(dataSet.FieldValue!=='$object$'){
					  var $input = "<input type='text' style='width:200px;' value='"+dataSet.FieldValue+"' />"
					  $html.append("<label>"+dataSet.FieldName+ "</label>"+$input);
				  }
				  else{
